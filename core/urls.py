...
urlpatterns = [
    ...
    path(
        'dashboard/os-por-funcionario/',
        views.DashboardOsPorFuncionarioView.as_view(),
        name='dashboard_os_por_funcionario',
    ),
    path(
        'dashboard/produtos-mais-vendidos/',
        views.DashboardProdutosMaisVendidosView.as_view(),
        name='dashboard_produtos_mais_vendidos',
    ),
    path(
        'dashboard/estoque-critico/',
        views.DashboardEstoqueCriticoView.as_view(),
        name='dashboard_estoque_critico',
    ),
    ...
    path('produtos/importar/', views.importar_produtos_csv, name='produtos_import'),
    ...
    path('empresas/aprovacoes/', views.EmpresaAprovacaoView.as_view(), name='empresas_aprovacao'),
    path('empresa/renovar/', views.EmpresaRenovacaoView.as_view(), name='empresa_renovar'),
    path('empresa/editar/', views.EmpresaUpdateView.as_view(), name='empresa_update'),
